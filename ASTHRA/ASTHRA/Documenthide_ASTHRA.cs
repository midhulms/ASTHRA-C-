...
namespace ASTHRA
{
    public partial class Documenthide_ASTHRA : Form
    {
        public Documenthide_ASTHRA()
        {
            InitializeComponent();
        }
         ...
         private void Selectimage_Click(object sender, EventArgs e)
        {
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
               ...
               imageselect.Text = loadedTrueImagePath;
                ...
                size_lbl.Text = smalldecimal(fs.ToString(), 2) + " KB";
              height_lbl.Text = loadedTrueImage.Height.ToString() + " Pixel";
              widthlbl.Text = loadedTrueImage.Width.ToString() + " Pixel";
                double cansave = (8.0 * ((height * (width / 3) * 3) / 3 - 1)) / 1024;
          cansavelbl.Text = smalldecimal(cansave.ToString(), 2) + " KB";
        ...
        private void Selectfile_Click(object sender, EventArgs e)
        {
...

            {
                ...
                Fileselect.Text = loadedFilePath;
...
/*****
 * 
 * encryption button this can be used encrypte 
 * 
 * ****/
        ...
        
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                return;
            if ( imageselect.Text == String.Empty ||     Fileselect.Text == String.Empty)
            {
        ...
        {
            toolStripStatusLabel1.Text ="Embedding the file... Please wait";
...
/****
 * decryption tool this button is used for decrypting 
 * ****/
        private void encrypte_Click(object sender, EventArgs e)
        {


            if (Savefile.Text == String.Empty || selectencrypteimage.Text == String.Empty)
            {
...
/// <param name="e"></param>
        private void Selectencryptedimage_Click(object sender, EventArgs e)
        {
            if (openFileDialog3.ShowDialog() == DialogResult.OK)
            {
               ...
               // loadedTrueImage = Image.FromFile(loadedTrueImagePath);
                ...
                selectencrypteimage.Text = DLoadImagePath;
                DecryptedImage = Image.FromFile(DLoadImagePath);
                openFileDialog3.Filter = "Image Files (*.jpeg; *.png; *.bmp)|*.jpg; *.png; *.bmp";
                ...
                float fs = (float)imginf.Length / 1024;
                size_lbl.Text = smalldecimal(fs.ToString(), 2) + " KB";
                height_lbl.Text = DecryptedImage.Height.ToString() + " Pixel";
                widthlbl.Text = DecryptedImage.Width.ToString() + " Pixel";
                double cansave = (8.0 * ((height * (width / 3) * 3) / 3 - 1)) / 1024;
                  cansavelbl.Text = smalldecimal(cansave.ToString(), 2) + " KB";
 ...
 * ***************/
        ...
        private void Documentcs_Load(object sender, EventArgs e)
        {
